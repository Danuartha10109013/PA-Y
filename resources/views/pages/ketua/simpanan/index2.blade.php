    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            selectedCheckboxes.forEach(checkbox => {
                ...
                $.ajax({
                    url: "{{ route('update.approval.ketua.berjangka', ['id' => 'ID', 'status' => 'STATUS']) }}"
                        .replace('ID', id)
...
<script>
    $(document).ready(function() {
        // Fetch count for All
        $.ajax({
            url: '/count-data-simpanan-berjangka/all',
            type: 'GET',
            success: function(response) {
        ...
        $.ajax({
            url: '/count-data-simpanan-berjangka/approved',
            type: 'GET',
            success: function(response) {
        ...
        $.ajax({
            url: '/count-data-simpanan-berjangka/pending',
            type: 'GET',
            success: function(response) {
        ...
        $.ajax({
            url: '/count-data-simpanan-berjangka/rejected',
            type: 'GET',
            success: function(response) {
