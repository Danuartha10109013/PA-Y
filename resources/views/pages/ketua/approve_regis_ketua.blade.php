@if (auth()->user()->hasRole('ketua'))
    ...
    @section('content')
            ...
            <div class="search-bar d-flex align-items-center">
                ...
                <div class="ml-auto d-flex">
                    ...
                    <button id="rejectButton" type="submit" class="btn btn-danger"
                        onclick="updateStatus('Ditolak')">Tolak</button>
                </div>
            </div>
            @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($data->status_ketua == 'Ditolak')
                                            <a href="#" data-toggle="modal" data-target="#rejectionMessageModal"
                                                data-message="{{ $data->alasan_ditolak }}"
                                                onclick="rejectionMessageModal(this)">
        ...
        <div class="modal fade" id="rejectionMessageModal" tabindex="-1" role="dialog"
            aria-labelledby="rejectionMessageModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
            ...
            function updateStatus(status) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            selectedCheckboxes.forEach(checkbox => {
                                const id = checkbox.getAttribute('data-id');
                                $.ajax({
                                    url: "{{ route('approve.diterima-ketua', ['id' => 'ID', 'status' => 'STATUS']) }}"
                                        .replace('ID', id)
                ...
                $(document).ready(function() {
                    ...
                    $(document).on('click', '.save-reject', function() {
                        ...
                        $.ajax({
                            url: `/ketua/anggota/reject/${id}`, // Endpoint Laravel
                            type: "POST",
                            data: {
        ...
        <script>
            function filterData(status) {
                ...
                $.ajax({
                    url: `/ketua/data/filter`, // URL endpoint filter
                    type: 'GET',
                    data: {
                        status: status
            ...
            function searchData() {
                ...
                $.ajax({
                    url: '/ketua/data/search', // Endpoint Laravel
                    type: 'GET',
                    data: {
                        query: query
            ...
            function deleteData(element) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: `/ketua/data/delete/${dataId}`, // Endpoint Laravel untuk menghapus data
                            type: 'DELETE',
                            data: {
            ...
            function viewDetail(element) {
                ...
                $.ajax({
                    url: `/ketua/anggota/detail/${dataId}`, // Endpoint Laravel untuk mengambil data
                    type: 'GET',
                    success: function(response) {
            ...
            function openEditModal(element) {
                ...
                $.ajax({
                    url: `/ketua/anggota/detail/${dataId}`, // Endpoint untuk mendapatkan data anggota
                    type: 'GET',
                    success: function(response) {
            ...
            function saveEdit() {
                ...
                $.ajax({
                    url: `/ketua/anggota/update/${dataId}`, // Endpoint untuk menyimpan data
                    type: 'PUT',
                    data: formData,
                    success: function(response) {
