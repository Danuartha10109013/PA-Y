    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            selectedCheckboxes.forEach(checkbox => {
                ...
                $.ajax({
                    url: "{{ route('status.penarikan.sukarela', ['id' => 'ID', 'status' => 'STATUS']) }}"
                        .replace('ID', id)
...
<script>
    $(document).ready(function() {
        // Fetch count for All
        $.ajax({
            url: '/count-data-penarikan-sukarela/all',
            type: 'GET',
            success: function(response) {
        ...
        $.ajax({
            url: '/count-data-penarikan-sukarela/approved',
            type: 'GET',
            success: function(response) {
        ...
        $.ajax({
            url: '/count-data-penarikan-sukarela/pending',
            type: 'GET',
            success: function(response) {
        ...
        $.ajax({
            url: '/count-data-penarikan-sukarela/rejected',
            type: 'GET',
            success: function(response) {
